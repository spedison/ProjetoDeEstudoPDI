...
public class ExibidorListaDeImagens extends Application {
    ...
    public Stage montaJanela(Stage primaryStage) {
        ...
        ExibidorListaDeImagens.primaryStage = primaryStage;
    ...
    private HBox criaBotoes() {
        ...
        Button proximaImagem = new Button("Próxima Imagem");
        ...
        Button imagemAnterior = new Button("Imagem Anterior");
